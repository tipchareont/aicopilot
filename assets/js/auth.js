...
window.Auth = (() => {
  ...
  const PROTECTED_ROUTES = new Set(['dashboard','campaign','creative','creative-weekly','scale-advisor','ai-chat','action-center','workspace','google-overview','google-campaign','google-insights']);
